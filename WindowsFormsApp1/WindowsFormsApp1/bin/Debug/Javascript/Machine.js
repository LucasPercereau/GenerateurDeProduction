function Machine(posX,posY,capacite,temps,objS){
  this.x=posX;
  this.y=posY;
...
Machine.prototype.draw = function() {
  ...
  ctx.drawImage(myImg,this.x,this.y,30,50);
...
Machine.prototype.addToMachine= function(ball)
{
  if(this.nbBall==this.capacite)
  {
    ...
    setTimeout(this.sortir.bind(this), this.time*1000);  
  }
  this.draw();
}
...
Machine.prototype.next = function(objS){
	this.objS=objS;
}